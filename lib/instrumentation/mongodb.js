  ...
  function wrap(name, populateArgs, additionalContext) {
    shimmer.wrap(mongodb.Collection.prototype, name, function(original) {
      return function(...args) {
        ...
        // there could be other methods used on rv that requires us to finishSpan.
        // we currently don't use anything other than toArray or count so we're just patching up those two.
        const toArray = rv.toArray
